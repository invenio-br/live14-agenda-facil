...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference("Agenda.count") do
      post agendas_url, params: { agenda: { place_name: @agenda.place_name, professional_id: @agenda.professional_id } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { place_name: @agenda.place_name, professional_id: @agenda.professional_id } }
